...
INSERT INTO employees (id, user_id, employee_code, hire_date, job_title, status, contract_type, department_id, supervisor_employee_id, work_schedule_id)
VALUES
    ('44444444-4444-4444-4444-444444444401', '33333333-3333-3333-3333-333333333301', 'ADM-001', (CURRENT_DATE - INTERVAL '720 days')::date, 'Chief Administration Officer', 'ACTIVE', 'PERMANENT', '22222222-2222-2222-2222-222222222201', NULL, '11111111-1111-1111-1111-111111111101'),
    ('44444444-4444-4444-4444-444444444402', '33333333-3333-3333-3333-333333333302', 'HR-001', (CURRENT_DATE - INTERVAL '540 days')::date, 'HR Administrator', 'ACTIVE', 'PERMANENT', '22222222-2222-2222-2222-222222222202', '44444444-4444-4444-4444-444444444401', '11111111-1111-1111-1111-111111111101'),
    ('44444444-4444-4444-4444-444444444403', '33333333-3333-3333-3333-333333333303', 'DIR-001', (CURRENT_DATE - INTERVAL '900 days')::date, 'Operations Director', 'ACTIVE', 'PERMANENT', '22222222-2222-2222-2222-222222222205', '44444444-4444-4444-4444-444444444401', '11111111-1111-1111-1111-111111111101'),
    ('44444444-4444-4444-4444-444444444404', '33333333-3333-3333-3333-333333333304', 'ENG-001', (CURRENT_DATE - INTERVAL '480 days')::date, 'Engineering Manager', 'ACTIVE', 'PERMANENT', '22222222-2222-2222-2222-222222222203', '44444444-4444-4444-4444-444444444403', '11111111-1111-1111-1111-111111111101'),
    ('44444444-4444-4444-4444-444444444405', '33333333-3333-3333-3333-333333333305', 'OPS-001', (CURRENT_DATE - INTERVAL '420 days')::date, 'Project Supervisor', 'ACTIVE', 'PERMANENT', '22222222-2222-2222-2222-222222222204', '44444444-4444-4444-4444-444444444403', '11111111-1111-1111-1111-111111111102'),
    ('44444444-4444-4444-4444-444444444406', '33333333-3333-3333-3333-333333333306', 'ENG-002', (CURRENT_DATE - INTERVAL '250 days')::date, 'Frontend Engineer', 'ACTIVE', 'PERMANENT', '22222222-2222-2222-2222-222222222203', '44444444-4444-4444-4444-444444444404', '11111111-1111-1111-1111-111111111101'),
    ('44444444-4444-4444-4444-444444444407', '33333333-3333-3333-3333-333333333307', 'OPS-002', (CURRENT_DATE - INTERVAL '210 days')::date, 'Business Analyst', 'ACTIVE', 'FIXED_TERM', '22222222-2222-2222-2222-222222222204', '44444444-4444-4444-4444-444444444405', '11111111-1111-1111-1111-111111111102'),
    ('44444444-4444-4444-4444-444444444408', '33333333-3333-3333-3333-333333333308', 'PRD-001', (date_trunc('month', CURRENT_DATE)::date + INTERVAL '2 days')::date, 'Product Owner', 'ACTIVE', 'PERMANENT', '22222222-2222-2222-2222-222222222205', '44444444-4444-4444-4444-444444444403', '11111111-1111-1111-1111-111111111101'),
    ('44444444-4444-4444-4444-444444444409', '33333333-3333-3333-3333-333333333309', 'HR-002', (date_trunc('month', CURRENT_DATE)::date + INTERVAL '5 days')::date, 'Office Coordinator', 'ACTIVE', 'FIXED_TERM', '22222222-2222-2222-2222-222222222202', '44444444-4444-4444-4444-444444444402', '11111111-1111-1111-1111-111111111101'),
    ('44444444-4444-4444-4444-444444444410', '33333333-3333-3333-3333-333333333310', 'HR-003', (CURRENT_DATE - INTERVAL '400 days')::date, 'Recruitment Assistant', 'TERMINATED', 'FIXED_TERM', '22222222-2222-2222-2222-222222222202', '44444444-4444-4444-4444-444444444402', '11111111-1111-1111-1111-111111111101')
ON CONFLICT (id) DO UPDATE
